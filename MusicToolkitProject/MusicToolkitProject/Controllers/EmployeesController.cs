...
using MusicToolkitProject.Models;

namespace MusicToolkitProject.Controllers
{
    public class EmployeesController : Controller
    {
        private MusicToolkitDBEntities db = new MusicToolkitDBEntities();
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FirstName,LastName,HireDate,RoleID,PhoneNum,AddressID,Email,Active,Password")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FirstName,LastName,HireDate,RoleID,PhoneNum,AddressID,Email,Active,Password")] Employee employee)
        {
            if (ModelState.IsValid)
            {
